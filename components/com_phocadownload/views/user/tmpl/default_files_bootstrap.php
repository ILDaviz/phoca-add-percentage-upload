...
<!-- Mod - 22/08/2018 Aggiunta della barra di avanzamento -->
<script type="text/javascript">
$(function() {
...
$('#phocadownload-upload-form').ajaxForm({
    beforeSend: function() {
        //status.empty();
        var percentVal = '0%';
	...
	complete: function(xhr) {
		window.location.href = '<?php echo $this->t['actionamp'] ?>task=result;';
...
<!-- END Mod - 22/08/2018 Aggiunta della barra di avanzamento -->
...
<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
	<div class="col-sm-12 col-md-4">
		<h4>Select category/Seleziona categoria dove caricare i file.</h4>
		<?php echo $this->listsfiles['catid'] ?></div>
</div>
...
<!-- Errori ed Avvisi -->
<?php 
if ($_SESSION['ft_errorfile_idcat'] != '') {
	echo '<div class="alert alert-error alert-danger">'
			.'<button type="button" class="close" data-dismiss="alert">&times;</button>' . $_SESSION['ft_errorfile_idcat'] . '</div>';
} 
if ($_SESSION['ft_errorfile_email'] != '') {
	echo '<div class="alert alert-error alert-danger">'
			.'<button type="button" class="close" data-dismiss="alert">&times;</button>' . $_SESSION['ft_errorfile_email'] . '</div>';
} 
if ($_SESSION['ft_errorfile_idweb'] != '') {
	echo '<div class="alert alert-error alert-danger">'
			.'<button type="button" class="close" data-dismiss="alert">&times;</button>' . $_SESSION['ft_errorfile_idweb'] . '</div>';
} 
if ($_SESSION['ft_errorfile_format_size'] != '') {
	echo '<div class="alert alert-error alert-danger">'
			.'<button type="button" class="close" data-dismiss="alert">&times;</button>' . $_SESSION['ft_errorfile_format_size'] . '</div>';
} 
if ($_SESSION['ft_errorfile_error_upload'] != '') {
	echo '<div class="alert alert-error alert-danger">'
			.'<button type="button" class="close" data-dismiss="alert">&times;</button>' . $_SESSION['ft_errorfile_error_upload'] . '</div>';
} 
?>
...
<table class="pd-user-upload-table">
	<tr>
		<td><strong><?php echo JText::_('COM_PHOCADOWNLOAD_FILENAME');?>:</strong></td><td>
			...
			<input class="form-control pd-input-small" id="file-upload-filename" name="file-upload-filename" readonly="" type="text" onchange="uploadFile()"> 
